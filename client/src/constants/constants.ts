...
export const addEarningUrl = `${domain}/add-earnings`
export const addDepositUrl = `${domain}/pay-with-id`
export const emailRoute = `${domain}/email`
...
export const getInvestorUrl = `${domain}/investor`
